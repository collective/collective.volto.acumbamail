...
myst:
  html_meta:
    "description": "An integration for the Acumbamail service with Plone"
    "property=og:description": "An integration for the Acumbamail service with Plone"
    "property=og:title": "Acumbamail integration with Plone"
    "keywords": "Acumbamail, service, Plone, integration, documentation"
---
...
The license for this {term}`add-on` is [MIT](https://raw.githubusercontent.com/collective/collective.volto.acumbamail/refs/heads/main/LICENSE).
